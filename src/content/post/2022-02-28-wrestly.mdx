...
import request from "~/assets/images/screens/Wrestly-api-useful.png";
import listing from "~/assets/images/screens/Wrestly-List.png";
...
<Image src={listing} alt="Lists of requests that have come in" />
...
<Image src={request} alt="Details of a single request" />
