...
featured: true
title: How To Hire Engineers
description: Shifting the focus in engineering interviews to ensure you get more trust and knowledge on candidates, whilst also protecting them from getting the wrong message!
excerpt: Hiring engineers is horribly difficult, you either have to make a call on someone with a tiny window of visibility or create a lengthy process that puts people off. In this article I show you how to hit that sweet spot of teasing out whether a candidate has the desired skills and behaviors, without spending weeks getting there.
image: ~/assets/images/hiring.png
category: Managing
tags:
  - managing
  - engineering
canonical: https://royletron.dev/2022-12-03-hiring
---

import { Image } from "@astrojs/image/components";
import hiringImage1 from "~/assets/images/hiring/1.png";
import hiringImage2 from "~/assets/images/hiring/2.png";
import hiringImage3 from "~/assets/images/hiring/3.png";
import hiringImage4 from "~/assets/images/hiring/4.png";
...
<Image src={hiringImage1} alt="Presenting their journey through the code" />
...
<Image src={hiringImage2} alt="Give lots of space for their questions" />
...
<Image src={hiringImage3} alt="Get straight to pairing!" />
...
<Image src={hiringImage4} alt="Score carding is essential" />
